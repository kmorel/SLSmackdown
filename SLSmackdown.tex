...
nodes.  Because of recent constraints in building specialized visualization
clusters\lcite{Childs2007}, recent research focuses on performing
visualization directly on the same supercomputing architectures driving
simulation.  Whereas previous research considers rendering on the order of
hundreds of processes, recent efforts use over ten thousand
...
optimizations\lcite{Kendall2010}.  Although each of these studies improve
...
optimizations and that may or may not be publicly available.  The
...
bringing together multiple algorithms and optimizations together in a
...
of this compositing operation that determins the overall efficiency of
...
them to form its partition of the image.

One of the most popular image compositing algorithms is binary
swap\lcite{BinarySwap1,BinarySwap2}.

...
\author{
\alignauthor
Kenneth Moreland,$^{\ddagger}$ Wesley Kendall,$^{*}$ Tom Peterka,$^{\dagger}$ and Jian Huang$^{*}$\\
...
\conferenceinfo{SC11}{November 12--18, 2011, Seattle, Washington, USA}
\CopyrightYear{2011}
\crdata{978-1-4503-0771-0/11/11}
...
\begin{figure}[htbp]
  ...
  %%   \includegraphics[width=.97\linewidth]{images/CompositeImprovements0256}
  %% }
  %%
...
% The following seems pedantic and is enough to cause the paper to run over.
%% We should also note that limiting the number of partitions
%% also limits the number of partitions used in the minimal-copy image
...
\begin{figure}[bp]%Set to b because it happens to be in the right spot[htbp]
  \centering
...
\begin{figure}[htbp]
  ...
  \subfloat[Transparent Geometry]{
    \includegraphics[width=.9\linewidth]{images/ScalingTransparent}
    \label{fig:Scaling:Transparent}
  }

  \subfloat[Opaque Geometry]{
    \includegraphics[width=.9\linewidth]{images/ScalingOpaque}

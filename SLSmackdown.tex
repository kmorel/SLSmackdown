...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{images/IceTCompositeImprovements0256}
  \caption{Comparative performance of radix-k with improved compositing
    ...
    performed on 256 nodes of Intrepid in VN mode generating images with
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{images/IceTCompositeImprovements2048}
  \caption{Comparative performance of radix-k with improved compositing
    computation and changing the order of compositing.  All runs were
    performed on 2048 nodes of Intrepid in VN mode generating images with
    $2048 \times 2048$ pixels and transparent blending.}
